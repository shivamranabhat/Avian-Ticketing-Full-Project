...
class Business extends Component
{
    ...
    public function mount()
    {
        ...
        $existing = BusinessLink::where('user_id', Auth::id())
            ->select('name', 'url')
            ->get()
    ...
    public function saveLinks()
    {
        ...
        BusinessLink::where('user_id', $userId)->delete();
        ...
        session()->flash('status', 'Business links saved successfully!');
    ...
    {
        return view('livewire.pass.business');
    }
}
