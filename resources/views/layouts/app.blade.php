                                    ...
                                    <nav class="main-menu-container nav nav-pills flex-column sub-open active">
                                        ...
                                        <ul class="main-menu active" style="margin-left: 0px; margin-right: 0px;">
                                            ...
                                            <li class="slide__category"><span class="category-name">Main</span></li>
                                             ...
                                             <li class="slide"> <a href="{{route('content.index')}}"
                                                    class="side-menu__item {{request()->segment(2) == 'contents' || request()->segment(2) == 'content' ? 'active' : ''}}">
                                            ...
                                            <li class="slide has-sub"> <a href="javascript:void(0);"
                                              ...
                                              <li class="slide has-sub"> <a href="javascript:void(0);"
                                                    class="side-menu__item {{request()->segment(2) == 'seo' ? 'active' : ''}}">
                                                    <svg class="side-menu__icon" version="1.1" id="_x32_"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <span class="side-menu__label">Seo</span> <i
                                                        class="fe fe-chevron-right side-menu__angle"></i> </a>
                                                <ul class="slide-menu child1"
                                                    style="position: relative; left: 0px; top: 0px; margin: 0px; transform: translate3d(119.5px, 294px, 0px);"
                                                    data-popper-placement="bottom">

                                                    <li class="slide"> <a href="{{route('slug.index')}}"
                                                            class="side-menu__item {{ request()->segment(3) == 'slugs' || request()->segment(3) == 'slug' ? 'active' : ''}}">Slug</a>
                                                    </li>
                                                    <li class="slide"> <a href="{{route('script.index')}}"
                                                            class="side-menu__item {{ request()->segment(3) == 'scripts' || request()->segment(3) == 'script' ? 'active' : ''}}">Script</a>
                                                    </li>
                                                    <li class="slide"> <a href="{{route('tag.index')}}"
                                                            class="side-menu__item {{ request()->segment(3) == 'tags' || request()->segment(3) == 'tag' ? 'active' : ''}}">Tag</a>
                                                    </li>
                                                    <li class="slide"> <a href="{{route('graph.index')}}"
                                                            class="side-menu__item {{ request()->segment(3) == 'open-graphs' || request()->segment(3) == 'open-graph' ? 'active' : ''}}">Open Graph</a>
                                                    </li>
                                                    <li class="slide"> <a href="{{route('card.index')}}"
                                                            class="side-menu__item {{ request()->segment(3) == 'twitter-cards' || request()->segment(3) == 'twitter-card' ? 'active' : ''}}">Twitter Card</a>
                                                    </li>
