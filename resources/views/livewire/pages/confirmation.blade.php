<section>
    <div class="flex flex-col gap-y-8 px-6 py-2 sm:px-8 md:px-14 xl:px-24">
        ...
        <div class="details grid grid-cols-2 xl:grid-cols-9 gap-10">
            <div class="left-col col-span-2 xl:col-span-6 flex flex-col gap-y-8">
                ...
                <div class="border border-gray-300 rounded-lg p-4 flex flex-col gap-y-6" id="venue">
                    <div class="flex gap-x-4 items-center">
                        ...
                        <span
                            class="bg-gradient-to-b from-[#C22C9F] to-[#AA02FF] rounded px-4 py-2 text-xs text-white font-medium">
                            {{ $totalTickets }}X
                        </span>
                    </div>
            ...
            <div class="right-col col-span-2 xl:col-span-3">
                    ...
                    <div class="border border-gray-300 rounded-lg p-4 flex flex-col gap-y-6">
                        ...
                        <form wire:submit="confirmBooking" class="flex flex-col gap-y-4">
                            ...
                            <div class="input flex flex-col">
                                <label class="text-sm text-primary italic">Full Name <span
                                        class="text-red-400">*</span></label>
                                <input type="text" wire:model="name"
                                    class="border-b border-gray-400 px-1 py-2 focus:outline-none focus:border-pink">
                            </div>

                            <div class="input flex flex-col">
                                <label class="text-sm text-primary italic">Phone Number <span
                                        class="text-red-400">*</span></label>
                            ...
                            <div class="input flex flex-col">
                                <label class="text-sm text-primary italic">Email Address <span
                                        class="text-red-400">*</span></label>
                            ...
                            <div class="radio flex gap-x-6 items-center">
                                <div class="option flex gap-x-2 items-center">
                                    <input type="radio" wire:model="pay_method" value="esewa" id="esewa"
                                        class="w-4 h-4 accent-pink cursor-pointer">
                                    <label for="esewa" class="text-sm text-secondary italic flex items-center gap-x-1">
                                        <img src="https://cdn.esewa.com.np/ui/images/logos/esewa-icon-large.png"
                                            alt="esewa" class="w-6">
                                        eSewa
                                    </label>
                                </div>
                                ...
                                <div class="option flex gap-x-2 items-center">
                                    <input type="radio" wire:model="pay_method" value="khalti" id="khalti"
                                        class="w-4 h-4 accent-pink cursor-pointer">
