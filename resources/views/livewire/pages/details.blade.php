        ...
        <div class="details grid grid-cols-2 xl:grid-cols-9 gap-x-10">
            <div class="left-col col-span-2 xl:col-span-6 flex flex-col gap-y-8">
                ...
                <div class="flex flex-col gap-y-3 items-start">
                    ...
                    <button class="text-sm text-secondary">Show More</button>
                </div>
                <div class="flex xl:hidden flex-col gap-y-6">
                    ...
                    <div class="border border-gray-300 rounded-lg p-4 flex flex-col gap-y-6">
                        <div class="flex gap-x-4 items-center">
                            ...
                            <span
                                class="bg-gradient-to-b from-[#C22C9F] to-[#AA02FF] rounded px-4 py-2 text-xs text-white">4X</span>
                        </div>
                        <div class="flex flex-col gap-y-2">
                            <div class="flex items-center justify-between">
                                <p class="text-sm font-semibold text-primary italic">
                                    1 Fan Fit Ticket X 999
                                </p>
                        ...
                        <div class="flex justify-end">
                            <h5 class="italic font-semibold text-lg">Total: Rs 6,999</h5>
                        </div>
                    </div>
                    <a class="text-white rounded-lg text-center p-3 font-semibold uppercase cursor-pointer transition-all hover:duration-300 hover:ease-in hover:bg-gradient-to-r bg-gradient-to-b from-[#C22C9F] to-[#AA02FF] w-full"
                ...
                <div class="gallery flex flex-col gap-y-4 w-full">
                    ...
                    <div class="grid grid-cols-8 grid-rows-2 gap-2 md:gap-4">
                        ...
                        @php
                        $classes = match($index) {
                        0 => 'col-span-4 md:col-span-2 row-start-1',
                        1 => 'col-span-4 md:col-span-2 row-start-2',
                        2 => 'col-span-4 md:col-span-2 row-span-2',
                        3 => 'col-span-8 md:col-span-4 row-span-2',
                        default => 'hidden'
                        };
                        @endphp

                        <img src="{{ Storage::url($img) }}" class="{{ $classes }} w-full h-full object-cover rounded-xl"
