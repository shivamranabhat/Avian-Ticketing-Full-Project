        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="{{ route('slug.create') }}" class="btn btn-sm btn-primary">
                ...
                <table class="table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $slug->created_at->format('d M Y') }}
                            </td>

                            <td x-data="{ openModal: false }">
                                <div class="hstack gap-2">
                                    <a href="{{ route('slug.edit', $slug->slug) }}"
                                ...
                                <div x-show="openModal" class="modal-backdrop" style="display:none;">
                                    <div class="modal-box">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-delete" wire:click="delete({{ $slug->id }})"
            ...
            <div class="row mt-4">
                <div class="col-md-5">
                    Showing {{ $slugs->firstItem() }}
                    to {{ $slugs->lastItem() }}
                    of {{ $slugs->total() }} entries
                </div>
