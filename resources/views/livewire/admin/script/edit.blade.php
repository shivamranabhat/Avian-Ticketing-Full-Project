<div class="col-xl-12">
    <div class="card custom-card">
        <div class="card-header justify-content-between">
            <div class="card-title">Edit Script</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <select class="form-control" wire:model.defer="position">
                        ...
                        <option value="header" {{ $script->position == 'header' ? 'selected' : '' }}>Header</option>
                        <option value="footer" {{ $script->position == 'footer' ? 'selected' : '' }}>Footer</option>
                    </select>
