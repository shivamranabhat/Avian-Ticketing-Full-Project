        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="{{ route('graph.create') }}" class="btn btn-sm btn-primary">
            ...
            <div class="table-responsive">
                <table class="table text-nowrap">
                    ...
                    <tbody>
                        @forelse($graphs as $index => $graph)
                        <tr>
                            <td>{{ $graphs->firstItem() + $index }}</td>
                            ...
                            <td x-data="{ openModal: false }">
                                <div class="hstack gap-2">
                                    <a href="{{ route('graph.edit', $graph->slug) }}"
                                ...
                                <div x-show="openModal" class="modal-backdrop" style="display:none;">
                                    <div class="modal-box">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-delete" wire:click="delete({{ $graph->id }})"
            ...
            <div class="row mt-4">
                <div class="col-md-5">
                    Showing {{ $graphs->firstItem() }}
                    to {{ $graphs->lastItem() }}
                    of {{ $graphs->total() }} entries
                </div>
