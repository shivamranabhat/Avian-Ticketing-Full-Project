            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                   ...
                   <select class="form-control" wire:model.defer="page_id">
                        <option value="{{ $tag->page_id }}">{{ $tag->page->name }}</option>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" wire:model.defer="meta_description"></textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" wire:model.defer="meta_keywords"></textarea>
                    @error('meta_keywords') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <!-- Canonical Tag -->
                <div class="col-12">
                    <label class="form-label">Canonical Tag</label>
                    <input class="form-control" wire:model.defer="canonical_tag" />
                    @error('canonical_tag') <span class="text-danger">{{ $message }}</span> @enderror
                </div>
