            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="dataTables_filter d-flex justify-content-end align-items-center gap-2">
                        <label>
                            <input type="search" class="form-control form-control-sm" placeholder="Search by email, phone or slug..."
                                ...
                                <div x-show="openModal" class="modal-backdrop" style="display:none;">
                                    <div class="modal-box">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-delete" wire:click="delete({{ $account->id }})" @click="openModal = false">Delete</button>
                                        </div>
                                    </div>
                                </div>
