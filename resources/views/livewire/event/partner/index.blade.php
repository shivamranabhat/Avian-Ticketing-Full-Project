        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="{{ route('partner.create') }}" class="btn btn-sm btn-primary">
                ...
                <table class="table text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($partner->image)
                                <img src="{{ asset('storage/'.$partner->image) }}" width="80" class="rounded">
                                @else
                                —
                                @endif
                            </td>
                            ...
                            <td x-data="{ openModal: false }">
                                <div class="hstack gap-2">
                                    <a href="{{ route('partner.edit', $partner->slug) }}"
                                ...
                                <div x-show="openModal" class="modal-backdrop" style="display:none;">
                                    <div class="modal-box">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-delete" wire:click="delete({{ $partner->id }})"
