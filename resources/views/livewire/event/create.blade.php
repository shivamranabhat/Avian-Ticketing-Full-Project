        ...
        <form class="card-body" wire:submit="save" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select wire:model="event_category_id" class="form-select flex-grow-1">
                ...
                <div class="col-12">
                    ...
                    <!-- Preview for newly selected event images -->
                    ...
                    <div class="border rounded p-3 mb-3 bg-light">
                        <div class="row g-3 d-flex align-items-end">
                            ...
                            <div class="col-md-6">
                                ...
                                <!-- Preview for newly selected artist image -->
                                @if(!empty($artist['image']) && is_object($artist['image']) && method_exists($artist['image'], 'temporaryUrl'))
                                <div class="mt-3">
                                    <img src="{{ $artist['image']->temporaryUrl() }}" alt="artist preview"
                                         style="width:50px; height:50px; object-fit:cover; border-radius:8px; border:1px solid #ddd;">
                                </div>
                                @endif
                                <input type="file" class="form-control" wire:model="artists.{{ $index }}.image"
                                    accept="image/*">
                                @error("artists.$index.image") <span class="text-danger fs-12">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    @endforeach
